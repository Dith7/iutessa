...
class PageBlock(models.Model):
    BLOCK_TYPE_CHOICES = [
        ...
        # NOUVEAUX TYPES ACADÉMIQUES
        ('academic_filieres', 'Filières (Public)'),
        ('academic_admission', 'Admission & Inscription'),
        ('academic_frais', 'Frais de Scolarité'),
        ('academic_documents', 'Documents Requis'),
    ]
